...
public class MotionEventView3 extends AppCompatImageView {
    private static final String TAG = MotionEventView3.class.getSimpleName();
    ...
    public MotionEventView3(Context context) {
        this(context, null);
    }

    public MotionEventView3(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MotionEventView3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttrs(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext()
                .obtainStyledAttributes(attrs, R.styleable.MotionEventView3);
        mMaxScaleFactor = typedArray.getFloat(
                R.styleable.MotionEventView3_max_scale, MAX_SCALE_FACTOR);
        mMinScaleFactor = typedArray.getFloat(
                R.styleable.MotionEventView3_min_scale, UNSPECIFIED_SCALE_FACTOR);
        mRevertDuration = typedArray.getInteger(
                R.styleable.MotionEventView3_revert_duration, DEFAULT_REVERT_DURATION);
        mOpenScaleRevert = typedArray.getBoolean(
                R.styleable.MotionEventView3_open_scale_revert, false);
        mOpenRotateRevert = typedArray.getBoolean(
                R.styleable.MotionEventView3_open_rotate_revert, false);
        mOpenTranslateRevert = typedArray.getBoolean(
                R.styleable.MotionEventView3_open_translate_revert, false);
        mOpenAnimator = typedArray.getBoolean(
                R.styleable.MotionEventView3_open_animator, true);
        mScaleBy = typedArray.getInt(
                R.styleable.MotionEventView3_scale_center, SCALE_BY_IMAGE_CENTER);
        typedArray.recycle();
    }
    ...
    private void initImgPositionAndSize() {
        ...
        refreshImageRect();
        //将图片中心点平移到和控件中心点重合
        mMatrix.postTranslate(getPivotX() - mImageRect.centerX(), getPivotY() - mImageRect.centerY());
        applyMatrix();
    ...
    protected void translate(PointF midPoint) {
        ...
        LogUtils.INSTANCE.e("on test", "dx:" + dx + "==>dy:" + dy);
