 ...
 * @version
 */
class DownRetrofitManager private constructor() {
    ...
    private object InstanceHolder {
        val INSTANCE: DownRetrofitManager = DownRetrofitManager()
    }

    companion object {
        val instance: DownRetrofitManager by lazy { InstanceHolder.INSTANCE }
    ...
    private fun addPublicInterceptor(builder: OkHttpClient.Builder) {
        val publicInterceptor = BasicHttpParams.Builder()
            ...
            //.addHeaderParam("Authorization","用户标识")
            .build()
